...
const DatePicker = React.forwardRef((props, ref) => {
    ...
    const {value, onChange, defaultValue, timePlaceholder, hasTime, locale, maxDate} = props;
    ...
    return (
        <div className={cx('ace-c-date-picker')} ref={ref}>
                    ...
                    <div className={cx('ace-c-date-picker__table')}>
                        ...
                        <div className={cx('ace-c-date-picker__date-table-body')}>
                            ...
                            {renderDaysArray.map(day => {
                                ...
                                const isDisabled = !!(maxDate && isValidDate(new Date(maxDate))
                ...
                <Fragment>
                    ...
                    <div className={cx('ace-c-date-picker__months-table-body')}>
                        {months.map((month, idx) => {
                            const isDisabled = !!(maxDate && isValidDate(new Date(maxDate))
                                && new Date(maxDate).getFullYear() === activeData.year
...
export default withFormContext(DatePicker);
