...
import {addIcon, Icon, minusIcon} from '../icons/index';
...
const InputCounter = React.forwardRef((props, ref) => {
    ...
    const {name, value, onChange, isDisabled, isLimitationAchieved} = props;
    ...
    return (
        <div ref={ref} className={cx('ace-c-input-counter', [className])}>
            ...
            <div className={cx('ace-c-input-counter__controls')}>
                ...
                >
                    <Icon
                        icon={minusIcon}
                        className={cx(['ace-c-icon--24', 'ace-c-input-counter__minus-icon'])}
                    />
                </button>
                <input
                ...
                >
                    <Icon
                        icon={addIcon}
                        className={cx(['ace-c-icon--24', 'ace-c-input-counter__plus-icon'])}
                    />
                </button>
            </div>
        </div>
...
export default withFormContext(InputCounter);
